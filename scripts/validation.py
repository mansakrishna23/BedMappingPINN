...
glacier = 'Upernavik' # glacier name: either Upernavik, Narssap, or Deception
random_seed = np.random.randint(1, 9999)
ptype = 'mc sb vel' # mc = mass conservation, sb = stress balance, vel = include log velocity
output_subfolder = glacier+'-MCSB-NBC-VAL'
...
radar_file = "ValidationTracks_15km.mat" # ice thickness training data along specific flight tracks
